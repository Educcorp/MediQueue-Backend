...
const testTurnCreation = async () => {
  try {
    ...
    try {
      const response1 = await axios.post('http://localhost:3004/api/turnos/publico/auto', {
    ...
    try {
      const response2 = await axios.post('http://localhost:3004/api/turnos/publico/auto', {
        uk_area: '44b455aa-9d05-11f0-9aa4-a2aa5f0e9486'
      });
      console.log('✅ Turno creado exitosamente:', {
    ...
    try {
      const response3 = await axios.post('http://localhost:3004/api/turnos/publico/auto', {
